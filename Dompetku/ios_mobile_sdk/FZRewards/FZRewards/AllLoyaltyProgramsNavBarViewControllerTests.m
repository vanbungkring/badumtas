...
@interface AllLoyaltyProgramsNavBarViewControllerTests : XCTestCase

@property (nonatomic, retain) AllLoyaltyProgramsNavBarViewController *controller;

@end


@implementation AllLoyaltyProgramsNavBarViewControllerTests
...
- (void)testInit
{
    _controller = [[[AllLoyaltyProgramsNavBarViewController alloc] init] autorelease];
    
    XCTAssertNotNil(_controller,@"Initialization failure");
    
    XCTAssertTrue([_controller isKindOfClass: [AllLoyaltyProgramsNavBarViewController class]], @"Initialization failure");
}
